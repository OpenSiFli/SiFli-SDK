 ...
 * @return enum value for pin_function2
 */
#define PIN_MATRIX_PINMUX_ENUM_DEF(pad, func)    \
    PIN_FUNC_ENUM_DEF(pad, func, func)

/** Matrix pin function list */
#define PIN_MATRIX_FUNC_LIST \
...
#define PIN_ARBITRARY_FUNC_LIST PIN_MATRIX_FUNC_LIST
...
typedef enum
{
    ...
    /* Matrix function, enum value must be same as chip spec */
    PIN_MATRIX_FUNC_START = 16,
    /* Keep for compatibility */
...
typedef enum _pin_function2
{
    ...
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA00, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA01, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA02, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA03, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA04, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA05, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA06, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA07, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA08, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA09, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA10, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA11, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA12, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA13, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA14, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA15, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA16, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA17, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA18, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA19, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA20, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA21, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA22, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA23, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA24, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA25, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA26, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA27, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA28, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA29, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA30, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA31, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA32, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA33, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA34, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA35, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA36, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA37, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA38, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA39, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA40, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA41, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA42, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA43, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA44, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA45, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA46, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA47, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA48, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA49, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA50, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA51, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA52, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA53, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA54, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA55, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA56, PIN_MATRIX_FUNC_LIST),
    FOREACH_FUNC(PIN_MATRIX_PINMUX_ENUM_DEF, PA57, PIN_MATRIX_FUNC_LIST),
} pin_function2;
