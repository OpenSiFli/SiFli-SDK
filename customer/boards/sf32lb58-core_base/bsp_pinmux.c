...
void BSP_sd2_pinmux_config()
{
    ...
    HAL_PIN_Set_DS0(PAD_PA70, 1, 1);
    HAL_PIN_Set_DS1(PAD_PA70, 1, 1);

    HAL_PIN_Set_DS0(PAD_PA75, 1, 1);
    HAL_PIN_Set_DS1(PAD_PA75, 1, 1);

    HAL_PIN_Set_DS0(PAD_PA76, 1, 1);
    HAL_PIN_Set_DS1(PAD_PA76, 1, 1);

    HAL_PIN_Set_DS0(PAD_PA77, 1, 1);
    HAL_PIN_Set_DS1(PAD_PA77, 1, 1);

    HAL_PIN_Set_DS0(PAD_PA79, 1, 1);
    HAL_PIN_Set_DS1(PAD_PA79, 1, 1);

    HAL_PIN_Set_DS0(PAD_PA81, 1, 1);
    HAL_PIN_Set_DS1(PAD_PA81, 1, 1);
