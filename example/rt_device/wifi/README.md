...
2. **使能 AIC8800MC Wi-Fi 模块**
    ...
    - 开启：Enable aic8800mc wifi mode
        - 宏开关：`CONFIG_WIFI_USING_AIC8800MC`
        - 作用：使能 AIC8800MC Wi-Fi 模块，确保 Wi-Fi 模块能够被正确识别和使用

3. **使能 wpa_supplicant 应用框架**
...
4. **选择 wpa 使用的网卡（SWT6621SL 默认网卡为 m0）**
    - 路径：Third party packages
