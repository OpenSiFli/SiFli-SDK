...
源码路径: `SiFli-SDK/example/multimedia/lvgl/lvsf_v8_examples/src/widgets/multslider`

> 本例程已聚合到 `lvsf_v8_examples` 工程：在其 `project` 目录执行 `scons --board=<board> --menuconfig`，于「LVSF v8 widget examples → Select widget example」中选择 **multslider**，再编译运行。
