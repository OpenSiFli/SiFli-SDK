...
## Overview
<!-- 例程简介 -->
This example demonstrates the virtualization of a USB flash drive using RAM
based on cherryusb MSC, including:
+ The PC can view a USB flash drive named SiFli MSC DEMO through the file
  manager.
...
the PC can view a USB flash drive named SiFli MSC in the file manager. There is
a README.TXT file in the drive with the content "cherryusb device msc_ram
demo!".
