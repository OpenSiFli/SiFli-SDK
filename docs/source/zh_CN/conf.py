...
print("app_id:{}".format(os.environ.get('ALGOLIA_DOCSEARCH_APP_ID', '')))
docsearch_app_id = os.environ.get('ALGOLIA_DOCSEARCH_APP_ID', 'MP2Q53SJEZ')
docsearch_api_key = os.environ.get('ALGOLIA_DOCSEARCH_SEARCH_API_KEY', 'b577fff77d5100141bb3b415bd8ee47a')
