...
static const LCDC_InitTypeDef lcdc_int_cfg =
{
    ...
    .freq = DSI_FREQ_288MHZ,                               //DSI clk lane frequency(DDR frequency)
...
static void main(int argc, char **argv)
{
    ...
    /*
        Start partial writing framebuffer，

       RM69090_SetRegion is the function of setting LCD receive area, and it was called during partial write DSI LCD
    */
