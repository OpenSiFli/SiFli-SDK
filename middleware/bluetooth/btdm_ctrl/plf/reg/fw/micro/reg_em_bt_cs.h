 ...
 * </pre>
 */
#define EM_BT_FRCNTL_ADDR   (0x20408000 + EM_BT_CS_OFFSET)
...
__INLINE void em_bt_frcntl_pack(int elt_idx, uint8_t fpoll, uint8_t fwmspatt, uint8_t txbsyen, uint8_t rxbsyen, uint8_t dnabort, uint8_t samen, uint8_t lsamdsb, uint8_t format)
{
    ...
    EM_BT_WR(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BLE_RD(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ((uint16_t)0x800)) | ((uint16_t)fpoll << 15) | ((uint16_t)fwmspatt << 12) | ((uint16_t)txbsyen << 10) | ((uint16_t)rxbsyen << 9) | ((uint16_t)dnabort << 8) | ((uint16_t)samen << 7) | ((uint16_t)lsamdsb << 6) | ((uint16_t)format << 0));
}
...
__INLINE uint8_t em_bt_frcntl_rf_modtype_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__INLINE void em_bt_frcntl_rf_modtype_setf(int elt_idx, uint8_t type)
{
    ASSERT_ERR((((uint16_t)type << 11) & ~((uint16_t)0x00000800)) == 0);
    EM_BT_WR(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_FRCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x00000800)) | ((uint16_t)type << 11));
}
 ...
 * </pre>
 */
#define EM_BT_CLKOFF0_ADDR   (0x20408002 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CLKOFF1_ADDR   (0x20408004 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_LINKCNTL_ADDR   (0x20408006 + EM_BT_CS_OFFSET)
...
__INLINE void em_bt_linkcntl_pack(int elt_idx, uint8_t aknena, uint8_t afhena, uint8_t laap, uint8_t whdsb, uint8_t acledr, uint8_t aclltaddr, uint8_t linklbl)
{
    ...
    EM_BT_WR(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ((uint16_t)0x000000E0)) | ((uint16_t)aknena << 15) | ((uint16_t)afhena << 14) | ((uint16_t)laap << 13) | ((uint16_t)whdsb << 12) | ((uint16_t)acledr << 11) | ((uint16_t)aclltaddr << 8) | ((uint16_t)linklbl << 0));
}
...
__INLINE uint8_t em_bt_linkcntl_iqval_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000E0)) >> 5);
}

__INLINE void em_bt_linkcntl_iqval_setf(int elt_idx, uint8_t value)
{
    ASSERT_ERR((((uint16_t)value << 5) & ~((uint16_t)0x000000E0)) == 0);
    EM_BT_WR(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_LINKCNTL_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x000000E0)) | ((uint16_t)value << 5));
}
 ...
 * </pre>
 */
#define EM_BT_BDADDR_ADDR   (0x20408008 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_BCH0_ADDR   (0x2040800E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_BCH1_ADDR   (0x20408010 + EM_BT_CS_OFFSET)
 ...
 *  -----   ------------------   -----------
 *  15:06             RXMAXBUF   0x0
 *  03:02           HP_LP_MODE   0x0
 *  01:00                 BCH2   0x0
 * </pre>
 */
#define EM_BT_RXMAXBUF_BCH2_ADDR   (0x20408012 + EM_BT_CS_OFFSET)
...
#define EM_BT_HP_LP_MODE_MASK   ((uint16_t)0x0000000C)
#define EM_BT_HP_LP_MODE_LSB    2
#define EM_BT_HP_LP_MODE_WIDTH  ((uint16_t)0x00000002)
...
#define EM_BT_HP_LP_MODE_RST    0x0
#define EM_BT_BCH2_RST          0x0

__INLINE void em_bt_rxmaxbuf_bch2_pack(int elt_idx, uint16_t rxmaxbuf, uint8_t hplpmode, uint8_t bch2)
{
    ASSERT_ERR((((uint16_t)rxmaxbuf << 6) & ~((uint16_t)0x0000FFC0)) == 0);
    ASSERT_ERR((((uint16_t)hplpmode << 2) & ~((uint16_t)0x0000000C)) == 0);
    ASSERT_ERR((((uint16_t)bch2 << 0) & ~((uint16_t)0x00000003)) == 0);
    EM_BT_WR(EM_BT_RXMAXBUF_BCH2_ADDR + elt_idx * REG_EM_BT_CS_SIZE, ((uint16_t)rxmaxbuf << 6) | ((uint16_t)hplpmode << 2) | ((uint16_t)bch2 << 0));
}

__INLINE void em_bt_rxmaxbuf_bch2_unpack(int elt_idx, uint16_t *rxmaxbuf, uint8_t *hplpmode, uint8_t *bch2)
{
    uint16_t localVal = EM_BT_RD(EM_BT_RXMAXBUF_BCH2_ADDR + elt_idx * REG_EM_BT_CS_SIZE);

    *rxmaxbuf = (localVal & ((uint16_t)0x0000FFC0)) >> 6;
    *hplpmode = (localVal & ((uint16_t)0x0000000C)) >> 2;
...
__INLINE uint8_t em_bt_rxmaxbuf_bch2_hp_lp_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_BT_RD(EM_BT_RXMAXBUF_BCH2_ADDR + elt_idx * REG_EM_BT_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000000C)) >> 2);
}

__INLINE void em_bt_rxmaxbuf_bch2_hp_lp_mode_setf(int elt_idx, uint8_t hplpmode)
{
    ASSERT_ERR((((uint16_t)hplpmode << 2) & ~((uint16_t)0x0000000C)) == 0);
    EM_BT_WR(EM_BT_RXMAXBUF_BCH2_ADDR + elt_idx * REG_EM_BT_CS_SIZE, (EM_BT_RD(EM_BT_RXMAXBUF_BCH2_ADDR + elt_idx * REG_EM_BT_CS_SIZE) & ~((uint16_t)0x0000000C)) | ((uint16_t)hplpmode << 2));
}
 ...
 * </pre>
 */
#define EM_BT_PWRCNTL_ADDR   (0x20408014 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXRXCNTL_ADDR   (0x20408016 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_WINCNTL_ADDR   (0x20408018 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXDESCPTR_ADDR   (0x2040801A + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CHMAP0_ADDR   (0x2040801C + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CHMAP1_ADDR   (0x2040801E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CHMAP2_ADDR   (0x20408020 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CHMAP3_ADDR   (0x20408022 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_CHMAP4_ADDR   (0x20408024 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_LOOPCNTL_ADDR   (0x20408026 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_MAXFRMTIME_ADDR   (0x20408028 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_SAM_PTR_ADDR   (0x2040802A + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_SAM_CNTL_ADDR   (0x2040802C + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_SK_ADDR   (0x2040802E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_IV_ADDR   (0x2040803E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXCCMPLDCNT0_ADDR   (0x20408046 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXCCMPLDCNT1_ADDR   (0x20408048 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXCCMPLDCNT2_ADDR   (0x2040804A + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCCMPLDCNT0_ADDR   (0x2040804C + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCCMPLDCNT1_ADDR   (0x2040804E + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCCMPLDCNT2_ADDR   (0x20408050 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCLKN0_ADDR   (0x20408052 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXCLKN1_ADDR   (0x20408054 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXBIT_ADDR   (0x20408056 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_TXDESCCNT_ADDR   (0x20408058 + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_RXDESCCNT_ADDR   (0x2040805A + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_ACLTXSTAT_ADDR   (0x2040805C + EM_BT_CS_OFFSET)
 ...
 * </pre>
 */
#define EM_BT_ACLRXSTAT_ADDR   (0x2040805E + EM_BT_CS_OFFSET)
