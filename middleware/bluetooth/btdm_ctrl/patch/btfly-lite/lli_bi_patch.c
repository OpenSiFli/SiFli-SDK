...
__STATIC void lli_big_start(struct lli_big_env *p_big_env)
{
    ...
    if (p_big_info->framing == ISO_UNFRAMED_MODE)
    {
        ...
        p_big_params->trans_latency = (p_big_params->update_offset - BLE_MSS_DUR) + p_big_params->pretrans_dur
    ...
    if (GETB(p_big_env->info, LLI_BIG_BROADCASTER))
    {
        ...
        // compute BIG delay
        big_sync_delay = p_big_params->update_offset - BLE_MSS_DUR;
...
__STATIC uint8_t lli_big_compute_params(const struct hci_le_create_big_cmd *p_param, struct hci_le_create_big_test_cmd *p_comp)
{
    ...
    // Save the number of subevents
    {
        ...
        // add the margin
        uint32_t sub_evt_dur = air_evt_dur + lli_env.sub_evt_margin;

        // Consider a bandwidth use of (6/10)
        uint8_t max_nse = (iso_intv * SLOT_SIZE * 2 * 6) / (p_param->num_bis * sub_evt_dur * 10);
...
void lli_bi_init_patch(bool is_reset)
{
#if !(BLE_BIS_IN_ROM)
    if (is_reset)
    {
...
uint8_t lli_bis_data_path_set_patch(uint8_t act_id, uint8_t direction, uint8_t data_path_type)
{
...
uint8_t lli_bis_data_path_remove_patch(uint8_t act_id, uint8_t direction)
{
#if !(BLE_BIS_IN_ROM)
    uint8_t status = CO_ERROR_UNKNOWN_CONNECTION_ID;
    struct lli_bis_env *p_bis_env = lli_bis_env[act_id];
 ...
 ****************************************************************************************
 */
int hci_le_create_big_test_cmd_handler_patch(struct hci_le_create_big_test_cmd *p_param, uint16_t opcode)
{
 ...
 ****************************************************************************************
 */
int hci_le_create_big_cmd_handler_patch(struct hci_le_create_big_cmd *p_param, uint16_t opcode)
{
 ...
 ****************************************************************************************
 */
int hci_le_big_create_sync_cmd_handler_patch(struct hci_le_big_create_sync_cmd const *p_param, uint16_t opcode)
{
    // Allocate the status event to be sent to the host
    struct hci_cmd_stat_event *p_evt = KE_MSG_ALLOC(HCI_CMD_STAT_EVENT, 0, opcode, hci_cmd_stat_event);
#if    !(BLE_BIS_IN_ROM)
 ...
 ****************************************************************************************
 */
int hci_le_terminate_big_cmd_handler_patch(struct hci_le_terminate_big_cmd const *p_param, uint16_t opcode)
{
    // Allocate the status event to be sent to the host
    struct hci_cmd_stat_event *p_evt = KE_MSG_ALLOC(HCI_CMD_STAT_EVENT, 0, opcode, hci_cmd_stat_event);
#if !(BLE_BIS_IN_ROM)
 ...
 ****************************************************************************************
 */
int hci_le_big_terminate_sync_cmd_handler_patch(struct hci_le_big_terminate_sync_cmd const *p_param, uint16_t opcode)
{
 ...
 ****************************************************************************************
 */
int lld_big_stop_ind_handler_patch(ke_msg_id_t const msgid, struct lld_big_stop_ind const *param,
 ...
 ****************************************************************************************
 */
int lld_big_tx_ind_handler_patch(ke_msg_id_t const msgid, struct lld_big_tx_ind const *param,
                                 ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
...
void lli_bi_ch_map_update_patch(struct le_ch_map *p_llm_ch_map)
{
#if !(BLE_BIS_IN_ROM)
    uint8_t nbchgood = 0;
 ...
 ****************************************************************************************
 */
int lld_big_rx_ind_handler_patch(ke_msg_id_t const msgid, struct lld_big_rx_ind const *param,
                                 ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
#if !(BLE_BIS_IN_ROM)
    // Pointer to the BIG information structure
 ...
 ****************************************************************************************
 */
int lld_big_sync_estab_ind_handler_patch(ke_msg_id_t const msgid, struct lld_big_sync_estab_ind const *param,
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
#if !(BLE_BIS_IN_ROM)
    // Pointer to the BIG information structure
 ...
 ****************************************************************************************
 */
int lld_big_sync_offset_upd_ind_handler_patch(ke_msg_id_t const msgid, struct lld_big_sync_offset_upd_ind const *param,
        ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
#if !(BLE_BIS_IN_ROM)
    // Pointer to the BIG information structure
 ...
 ****************************************************************************************
 */
int llm_acad_data_ind_handler_patch(ke_msg_id_t const msgid, struct llm_acad_data_ind const *param,
                                    ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
#if !(BLE_BIS_IN_ROM)
    uint8_t status = CO_ERROR_NO_ERROR;
...
uint8_t lli_bis_stats_get_patch(uint8_t act_id, uint32_t *crc_error_packets, uint32_t *rx_unreceived_packets)
{
#if !(BLE_BIS_IN_ROM)
    uint8_t status = CO_ERROR_UNKNOWN_CONNECTION_ID;
