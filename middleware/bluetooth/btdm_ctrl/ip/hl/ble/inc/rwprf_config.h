...
/// SiFli BLE server
#if defined(CFG_PRF_SIBLES) && defined(CFG_APP)
    #define BLE_SIBLE_SERVER      1
#else
    #define BLE_SIBLE_SERVER          0
#endif // defined(CONFIG_CFG_PRF_SIBLES)

#if defined(CFG_PRF_SIBLE_FORWARD)
    #define BLE_SIBLE_FORWARD     1
#else
    #define BLE_SIBLE_FORWARD     0
#endif // defined(CFG_PRF_SIBLE_FORWARD)
