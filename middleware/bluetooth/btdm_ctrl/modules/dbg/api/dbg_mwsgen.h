...
#include "rwip_config.h"
    ...
    */
        ...
        * @param[in]  rx_delay     Delay of the rx activity (us)
        * @param[in]  tx_delay     Delay of the tx activity (us)
        *
        ****************************************************************************************
        */
        ...
        /**
        ****************************************************************************************
        * @brief Configure the MWS COEX mode for BT.
        *
        * @param[in]  txmode
        * @param[in]  rxmode
        * @param[in]  txmsk
        ...
        */
        ...
        /**
        ****************************************************************************************
        * @brief Debug frame sync handler.
        *
        ****************************************************************************************
        */
